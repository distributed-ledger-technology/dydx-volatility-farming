...
// // Deno.test("should return account data", async () => {

// //     const result = await dydxConnector.getAccountData(testWallet)

// //     if (result === undefined) {
// //         fail(`I would have expected fancy account data`)
// //     }

// // })

// // Deno.test("should return open positions", async () => {

// //     const result = await dydxConnector.getPositions(testWallet)
